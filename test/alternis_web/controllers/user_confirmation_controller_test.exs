defmodule AlternisWeb.UserConfirmationControllerTest do
  ...
  describe "POST /users/confirm" do
    ...
    test "sends a new confirmation token", %{conn: conn, user: user} do
      ...
      assert Map.get(conn.assigns.flash, "info") =~ "If your email is in our system"
  ...
  describe "POST /users/confirm/:token" do
    test "confirms the given token once", %{conn: conn, user: user} do
      ...
      assert redirected_to(conn) == "/"
      assert Map.get(conn.assigns.flash, "info") =~ "User confirmed successfully"
      ...
      assert redirected_to(conn) == "/"
      refute Map.get(conn.assigns.flash, "error")
    end
